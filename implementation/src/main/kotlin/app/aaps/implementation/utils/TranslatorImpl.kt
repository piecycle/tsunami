...
class TranslatorImpl @Inject internal constructor(
    ...
    override fun translate(type: TE.Type?): String = when (type) {
        ...
        TE.Type.FALLING_ASLEEP          -> rh.gs(R.string.careportal_falling_asleep)
        TE.Type.WAKING_UP               -> rh.gs(R.string.careportal_waking_up)
        TE.Type.SICKNESS                -> rh.gs(R.string.careportal_sickness)
        TE.Type.STRESS                  -> rh.gs(R.string.careportal_stress)
        TE.Type.PRE_PERIOD              -> rh.gs(R.string.careportal_pre_period)
        TE.Type.ALCOHOL                 -> rh.gs(R.string.careportal_alcohol)
        TE.Type.CORTISONE               -> rh.gs(R.string.careportal_cortisone)
        TE.Type.FEELING_LOW             -> rh.gs(R.string.careportal_feeling_low)
        TE.Type.FEELING_HIGH            -> rh.gs(R.string.careportal_feeling_high)
