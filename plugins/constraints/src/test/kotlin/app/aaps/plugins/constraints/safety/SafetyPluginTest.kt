    ...
    fun prepare() {
        ...
        openAPSAMAPlugin =
            OpenAPSAMAPlugin(
                ...
                hardLimits, dateUtil, persistenceLayer, glucoseStatusProvider, preferences, determineBasalAMA, GlucoseStatusCalculatorSMB(aapsLogger, iobCobCalculator, dateUtil, decimalFormatter)
            )
    }
