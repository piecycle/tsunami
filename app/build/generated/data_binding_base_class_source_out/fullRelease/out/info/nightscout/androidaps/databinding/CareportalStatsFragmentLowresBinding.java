...
public final class CareportalStatsFragmentLowresBinding implements ViewBinding {
  @NonNull
  ...
  private CareportalStatsFragmentLowresBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull TextView careportalPblabel, @NonNull TextView careportalReservoirlevel,
      @NonNull TextView careportalSensorage, @NonNull TextView careportalSensorlevel) {
  ...
  @NonNull
  public static CareportalStatsFragmentLowresBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CareportalStatsFragmentLowresBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.careportal_stats_fragment_lowres, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CareportalStatsFragmentLowresBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CareportalStatsFragmentLowresBinding((FrameLayout) rootView,
          careportalBatterylevel, careportalCanulaage, careportalInsulinage, careportalPbage,
          careportalPblabel, careportalReservoirlevel, careportalSensorage, careportalSensorlevel);
    }
