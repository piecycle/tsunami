...
public final class ActivityPreferencesBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText prefFilter;

  private ActivityPreferencesBinding(@NonNull LinearLayout rootView,
      @NonNull FrameLayout frameLayout, @NonNull TextInputEditText prefFilter) {
    this.rootView = rootView;
    this.frameLayout = frameLayout;
    this.prefFilter = prefFilter;
  }
  ...
  public static ActivityPreferencesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.pref_filter;
      TextInputEditText prefFilter = rootView.findViewById(id);
      if (prefFilter == null) {
        break missingId;
      }

      return new ActivityPreferencesBinding((LinearLayout) rootView, frameLayout, prefFilter);
    }
