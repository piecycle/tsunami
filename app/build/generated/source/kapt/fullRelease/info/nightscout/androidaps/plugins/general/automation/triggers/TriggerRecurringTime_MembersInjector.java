...
public final class TriggerRecurringTime_MembersInjector implements MembersInjector<TriggerRecurringTime> {
  ...
  public TriggerRecurringTime_MembersInjector(Provider<AAPSLogger> aapsLoggerProvider,
  ...
  public static MembersInjector<TriggerRecurringTime> create(
      ...
      Provider<IobCobCalculatorPlugin> iobCobCalculatorPluginProvider,
      Provider<DateUtil> dateUtilProvider) {
    return new TriggerRecurringTime_MembersInjector(aapsLoggerProvider, rxBusProvider, resourceHelperProvider, profileFunctionProvider, spProvider, locationDataContainerProvider, treatmentsPluginProvider, activePluginProvider, iobCobCalculatorPluginProvider, dateUtilProvider);
  }

  @Override
  public void injectMembers(TriggerRecurringTime instance) {
  ...
  @InjectedFieldSignature("info.nightscout.androidaps.plugins.general.automation.triggers.TriggerRecurringTime.dateUtil")
  public static void injectDateUtil(TriggerRecurringTime instance, DateUtil dateUtil) {
