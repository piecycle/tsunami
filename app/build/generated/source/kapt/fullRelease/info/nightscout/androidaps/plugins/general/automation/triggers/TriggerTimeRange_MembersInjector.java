...
public final class TriggerTimeRange_MembersInjector implements MembersInjector<TriggerTimeRange> {
  ...
  public TriggerTimeRange_MembersInjector(Provider<AAPSLogger> aapsLoggerProvider,
  ...
  public static MembersInjector<TriggerTimeRange> create(Provider<AAPSLogger> aapsLoggerProvider,
      Provider<RxBusWrapper> rxBusProvider, Provider<ResourceHelper> resourceHelperProvider,
      Provider<ProfileFunction> profileFunctionProvider, Provider<SP> spProvider,
      Provider<LastLocationDataContainer> locationDataContainerProvider,
      Provider<TreatmentsPlugin> treatmentsPluginProvider,
      ...
      Provider<IobCobCalculatorPlugin> iobCobCalculatorPluginProvider,
      Provider<DateUtil> dateUtilProvider) {
    return new TriggerTimeRange_MembersInjector(aapsLoggerProvider, rxBusProvider, resourceHelperProvider, profileFunctionProvider, spProvider, locationDataContainerProvider, treatmentsPluginProvider, activePluginProvider, iobCobCalculatorPluginProvider, dateUtilProvider);
  }

  @Override
  public void injectMembers(TriggerTimeRange instance) {
  ...
  @InjectedFieldSignature("info.nightscout.androidaps.plugins.general.automation.triggers.TriggerTimeRange.dateUtil")
  public static void injectDateUtil(TriggerTimeRange instance, DateUtil dateUtil) {
