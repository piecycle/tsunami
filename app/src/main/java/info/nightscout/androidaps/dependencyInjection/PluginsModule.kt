...
import info.nightscout.androidaps.plugins.insulin.InsulinLyumjevU200Plugin
...
abstract class PluginsModule {
    ...
    @IntoMap
    @IntKey(43)
    abstract fun bindInsulinLyumjevU200Plugin(plugin: InsulinLyumjevU200Plugin): PluginBase
