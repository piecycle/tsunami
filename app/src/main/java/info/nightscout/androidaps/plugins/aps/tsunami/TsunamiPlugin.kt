...
open class TsunamiPlugin @Inject constructor(
    ...
    override fun invoke(initiator: String, tempBasalFallback: Boolean) {
        ...
        val iobArray = iobCobCalculator.calculateIobArrayForSMB(lastAutosensResult, TAEDefaults.exercise_mode, TAEDefaults.half_basal_exercise_target, isTempTarget)
        ...
        DetermineBasalAdapterTAEJS(ScriptReader(context), injector).also { determineBasalAdapterTAEJS ->
            ...
            if (determineBasalResultTAE == null) {
                ...
                if (determineBasalResultTAE.rate == 0.0 && determineBasalResultTAE.duration == 0 && iobCobCalculator.getTempBasalIncludingConvertedExtended(dateUtil.now()) == null) determineBasalResultTAE.tempBasalRequested = false
