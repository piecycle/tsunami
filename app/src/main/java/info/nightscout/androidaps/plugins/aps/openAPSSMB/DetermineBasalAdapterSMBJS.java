...
//        mProfile.put("UAM_PBolus2",SafeParse.stringToDouble(sp.getString(R.string.key_UAM_PBolus2,"1")));
        ...
        mProfile.put("UAM_ISF1",SafeParse.stringToDouble(sp.getString(R.string.key_UAM_ISF1,"4")));
        mProfile.put("UAM_ISF2",SafeParse.stringToDouble(sp.getString(R.string.key_UAM_ISF2,"20")));
