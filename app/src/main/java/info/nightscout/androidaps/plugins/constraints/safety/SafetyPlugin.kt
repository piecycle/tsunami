...
class SafetyPlugin @Inject constructor(
    ...
    override fun applyMaxIOBConstraints(maxIob: Constraint<Double>): Constraint<Double> {
        ...
        val maxIobPref: Double = when {
            tsunamiPlugin.isEnabled()     -> sp.getDouble( R.string.key_openapssmb_max_iob,3.0)
            openAPSSMBPlugin.isEnabled()  -> sp.getDouble( R.string.key_openapssmb_max_iob,3.0)
        ...
        if (tsunamiPlugin.isEnabled()) maxIob.setIfSmaller(aapsLogger, hardLimits.maxIobTAE(), String.format(resourceHelper.gs(R.string.limitingiob), hardLimits.maxIobSMB(), resourceHelper.gs(R.string.hardlimit)), this)
