...
class DetermineBasalResultTAE private constructor(injector: HasAndroidInjector) : APSResult(injector) {
    ...
    override fun newAndClone(injector: HasAndroidInjector): DetermineBasalResultTAE {
        val newResult = DetermineBasalResultTAE(injector)
        doClone(newResult)
