...
class TsunamiFragment : DaggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.run.setOnClickListener {
            tsunamiPlugin.invoke("OpenAPSSMB button", false)
        }
    }
    ...
    fun updateGUI() {
        ...
        tsunamiPlugin.lastDetermineBasalAdapterTAEJS?.let { determineBasalAdapterTAEJS ->
            ...
            binding.scriptdebugdata.text = determineBasalAdapterTAEJS.scriptDebug
