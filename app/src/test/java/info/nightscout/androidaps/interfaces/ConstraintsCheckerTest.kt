...
class ConstraintsCheckerTest : TestBaseWithProfile() {
    ...
    fun prepare() {
        ...
        tsunamiPlugin = TsunamiPlugin(injector, aapsLogger, rxBus, constraintChecker, rh, profileFunction, context, activePlugin, iobCobCalculator, hardLimits, profiler, sp, dateUtil, repository, glucoseStatusProvider)
        ...
        safetyPlugin = SafetyPlugin(injector, aapsLogger, rh, sp, rxBus, constraintChecker, openAPSAMAPlugin, openAPSSMBPlugin, sensitivityOref1Plugin, tsunamiPlugin, activePlugin, hardLimits, BuildHelperImpl(ConfigImpl(), fileListProvider), iobCobCalculator, ConfigImpl(), dateUtil)
