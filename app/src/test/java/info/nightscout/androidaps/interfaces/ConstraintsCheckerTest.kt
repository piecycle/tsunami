...
class ConstraintsCheckerTest : TestBaseWithProfile() {
    ...
    private lateinit var tsunamiPlugin: TsunamiPlugin
    ...
    fun prepare() {
        ...
        tsunamiPlugin = TsunamiPlugin(injector, aapsLogger, rxBus, constraintChecker, resourceHelper, profileFunction, context, activePlugin, iobCobCalculator, hardLimits, profiler, sp, dateUtil, repository, glucoseStatusProvider)
        ...
        safetyPlugin = SafetyPlugin(injector, aapsLogger, resourceHelper, sp, rxBus, constraintChecker, openAPSAMAPlugin, openAPSSMBPlugin, sensitivityOref1Plugin, tsunamiPlugin, activePlugin, hardLimits, BuildHelper(ConfigImpl(), fileListProvider), iobCobCalculator, ConfigImpl(), dateUtil)
