...
class DisplayFormatTest : WearTestBase() {
    ...
    @Test fun shortTrendTest() {
        ...
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(11, "1.2"), 0)).isEqualTo("11' 1.2")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(12, "0.7"), 0)).isEqualTo("12' Δ.7")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(10, "1.0"), 0)).isEqualTo("10' Δ1")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(14, "-5.0"), 0)).isEqualTo("14' Δ-5")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(13, "-5.1"), 0)).isEqualTo("13' -5")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(15, "0.87"), 0)).isEqualTo("15' .87")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(10, "-1.78"), 0)).isEqualTo("10' -2")
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(3, "2.549"), 0)).isEqualTo("3' 2.55")
        ...
        assertThat(displayFormat.shortTrend(rawDataMocker.rawDelta(14, "-5.0"), 0)).isEqualTo("14' -5")
    }

    @Test fun longGlucoseLine() {
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("125", 2, "1.2"), 0)).isEqualTo("125→ Δ1.2 (2')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("97", 11, "5.2"), 0)).isEqualTo("97↗ Δ5.2 (11')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("110", 12, "0.7"), 0)).isEqualTo("110→ Δ.7 (12')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("65", 10, "7.0"), 0)).isEqualTo("65↗ Δ7 (10')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("215", 14, "-5.0"), 0)).isEqualTo("215↘ Δ-5 (14')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("8.3", 13, "-5.1"), 0)).isEqualTo("8.3↘ Δ-5.1 (13')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("6.8", 15, "10.83"), 0)).isEqualTo("6.8↑ Δ10.83 (15')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("13.2", 10, "-11.78"), 0)).isEqualTo("13.2↓ Δ-11.78 (10')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("3.9", 3, "2.549"), 0)).isEqualTo("3.9→ Δ2.549 (3')")
        assertThat(displayFormat.longGlucoseLine(rawDataMocker.rawSgv("11.1", 1, "-15.563"), 0)).isEqualTo("11.1↓ Δ-15.563 (1')")
    }
    ...
    @Test fun longDetailsLineTest() {
        ...
        assertThat(displayFormat.longDetailsLine(rawDataMocker.rawCobIobBr("2(40)g", "-1.5U", "0.55U/h"), 0)).isEqualTo("2(40)g ⁞ -2U ⁞ 0.55U/h")
        assertThat(displayFormat.longDetailsLine(rawDataMocker.rawCobIobBr("0(24)g", "0.05U", "160%"), 0)).isEqualTo("0(24)g ⁞ 0.05U ⁞ 160%")
        assertThat(displayFormat.longDetailsLine(rawDataMocker.rawCobIobBr("47g", "13.87U", "220%"), 0)).isEqualTo("47g ⁞ 13.87U ⁞ 220%")
        assertThat(displayFormat.longDetailsLine(rawDataMocker.rawCobIobBr("13(5)g", "5.90U", "300%"), 0)).isEqualTo("13(5)g ⁞ 5.90U ⁞ 300%")
        assertThat(displayFormat.longDetailsLine(rawDataMocker.rawCobIobBr("11(50)g", "0U", "70%"), 0)).isEqualTo("11(50)g ⁞ 0U ⁞ 70%")
    ...
    @Test fun detailedIobTest() {
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("-1.29U", "(0,910|-2,20)"), 0)).isEqualTo(Pair.create("-1.29U", ",91 -2"))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("3.50U", ""), 0)).isEqualTo(Pair.create("3.50U", ""))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("12.5U", "(+1,4|-4.78)"), 0)).isEqualTo(Pair.create("12.5U", "1,4 -5"))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("0.67U", "some junks"), 0)).isEqualTo(Pair.create(".67U", ""))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("-11.0U", "(broken|data)"), 0)).isEqualTo(Pair.create("-11U", "-- --"))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("5.52U", "(0,5439|wrong)"), 0)).isEqualTo(Pair.create("5.52U", ",54 --"))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("-8.1U", "(|-8,1)"), 0)).isEqualTo(Pair.create("-8.1U", "-- -8"))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("-8.1U", "(|-8,1)"), 0)).isEqualTo(Pair.create("-8.1U", "-- -8"))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("7.6U", "(malformed)"), 0)).isEqualTo(Pair.create("7.6U", ""))
        assertThat(displayFormat.detailedIob(rawDataMocker.rawIob("-4.26U", "(6,97|1,3422|too much)"), 0)).isEqualTo(Pair.create("-4.26U", "7 1,3"))
    }

    @Test fun detailedCobTest() {
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("0g"), 0)).isEqualTo(Pair.create("0g", ""))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("50g"), 0)).isEqualTo(Pair.create("50g", ""))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("2(40)g"), 0)).isEqualTo(Pair.create("2g", "40g"))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("0(24)g"), 0)).isEqualTo(Pair.create("0g", "24g"))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("13(5)g"), 0)).isEqualTo(Pair.create("13g", "5g"))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("11(50)g"), 0)).isEqualTo(Pair.create("11g", "50g"))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("19(38)g"), 0)).isEqualTo(Pair.create("19g", "38g"))
        assertThat(displayFormat.detailedCob(rawDataMocker.rawCob("100(1)g"), 0)).isEqualTo(Pair.create("100g", "1g"))
    }
}
